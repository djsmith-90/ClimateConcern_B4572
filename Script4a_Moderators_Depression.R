...
### Script 4a: Analysis for Research Question 2 - Moderators between climate concern and depression
### Created 27/11/2024 by Dan Major-Smith
### R version 4.3.1
...
dat_actions <- dat %>%
  select(-c(actionBelief, gad7, wemwbs))
...
### Unadjusted
actions_cca_unadj <- lm(epds ~ climateConcern + totalActions + climateConcern:totalActions, 
...
avg_predictions(actions_cca_unadj, variables = "climateConcern")

## Average depression score by climate concern and certain values of climate action
predictions(actions_cca_unadj, newdata = datagrid(climateConcern = c("Not concerned", "Somewhat concerned", 
                                                                   "Very concerned"), 
                                                totalActions = c(0, 5, 10, 15)))

## Plot of predicted values showing interaction between climate concern and action
plot_predictions(actions_cca_unadj, condition = c("totalActions", "climateConcern"))


### Adjusted
actions_cca_adj <- lm(epds ~ climateConcern + totalActions + climateConcern:totalActions 
...
dat_belief <- dat %>%
  select(-c(totalActions, gad7, wemwbs))
...
### Unadjusted
beliefs_cca_unadj <- lm(epds ~ climateConcern + actionBelief + climateConcern:actionBelief, 
...
## Average depression score by climate concern
avg_predictions(beliefs_cca_unadj, variables = "climateConcern")

## Average depression score by climate concern and certain values of climate action
predictions(beliefs_cca_unadj, newdata = datagrid(climateConcern = c("Not concerned", "Somewhat concerned", 
                                                                   "Very concerned"), 
                                                actionBelief = c("No", "Yes")))

## Plot of predicted values showing interaction between climate concern and action
plot_predictions(beliefs_cca_unadj, condition = c("actionBelief", "climateConcern"))


### Adjusted
beliefs_cca_adj <- lm(epds ~ climateConcern + actionBelief + climateConcern:actionBelief 
                      + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                      + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                      + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                      + mat_imd + par_occSocClass + par_income + mat_home, 
...
## Remove other moderator from dataset (as will impute separately below), in addition to anxiety outcome (as measured at same time-point as depression outcome, provides no additional information to inform imputations)
dat_mi <- dat %>%
  select(-c(gad7, actionBelief))
...
form <- as.list(c(
  as.formula(smfq ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(prior_dep ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(gad7_prior ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(prior_anx ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(wemwbs_prior ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + prior_anx + gad7_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(sex ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(ethnicity ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(relationship ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(children ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(edu ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(occClass ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(income ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(imd ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(home ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(emoStab ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(openness ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_dep ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_anx ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(pat_dep ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(pat_anx ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_age ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_edu ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_imd ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(par_occSocClass ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_income + mat_home + wemwbs),
  as.formula(par_income ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + mat_home + wemwbs),
  as.formula(mat_home ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + wemwbs),
  as.formula(climateConcern ~ epds + totalActions + epds:totalActions 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(totalActions ~ epds + climateConcern + epds:climateConcern 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(epds ~ climateConcern + totalActions + climateConcern:totalActions 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(wemwbs ~ climateConcern + totalActions + climateConcern:totalActions + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home)
...
imp_mi <- mice(dat_mi, m = 50, maxit = 10, 
               method = meth, formulas = form, print = TRUE, seed = 34567)

## Save these imputations, to avoid having to run the imputations again
save(imp_mi, file = "MI_dep_totalActions_allInts.RData")
#load("MI_dep_totalActions_allInts.RData")


#### Now run substantive analysis model in each imputed dataset and combine using Rubin's rules

## Unadjusted
model <- with(imp_mi, lm(epds ~ climateConcern + totalActions + climateConcern:totalActions))
est <- pool(model)
...
for (i in 1:imp_mi$m) {
  ...
  mod_temp <- lm(epds ~ climateConcern + totalActions + climateConcern:totalActions 
                 + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                 + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                 + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                 + mat_imd + par_occSocClass + par_income + mat_home,
...
preds_rr
write_csv(preds_rr, file = "dep_actions_MI_AllInts_PredValues.csv")
...
form <- as.list(c(
  as.formula(smfq ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(prior_dep ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(gad7_prior ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(prior_anx ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(wemwbs_prior ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + prior_anx + gad7_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(sex ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(ethnicity ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(relationship ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(children ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(edu ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(occClass ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(income ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(imd ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(home ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(emoStab ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(openness ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_dep ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_anx ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(pat_dep ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(pat_anx ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_age ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_edu ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_imd ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(par_occSocClass ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_income + mat_home + wemwbs),
  as.formula(par_income ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + mat_home + wemwbs),
  as.formula(mat_home ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + wemwbs),
  as.formula(climateConcern ~ epds + actionBelief + epds:actionBelief 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(actionBelief ~ epds + climateConcern + epds:climateConcern 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(epds ~ climateConcern + actionBelief + climateConcern:actionBelief 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(wemwbs ~ climateConcern + actionBelief + climateConcern:actionBelief + epds
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home)
...
## Now run the proper imputation model. Will create 50 imputed datasets here with a burn-in period of 10 iterations
imp_mi <- mice(dat_mi, m = 50, maxit = 10, 
               method = meth, formulas = form, print = TRUE, seed = 12321)

## Save these imputations, to avoid having to run the imputations again
save(imp_mi, file = "MI_dep_actionBelief_allInts.RData")
#load("MI_dep_actionBelief_allInts.RData")


#### Now run substantive analysis model in each imputed dataset and combine using Rubin's rules

## Unadjusted
model <- with(imp_mi, lm(epds ~ climateConcern + actionBelief + climateConcern:actionBelief))
est <- pool(model)
...
for (i in 1:imp_mi$m) {
  print(paste0("On imputed dataset: ", i))
  df_temp <- complete(imp_mi, i)
  mod_temp <- lm(epds ~ climateConcern + actionBelief + climateConcern:actionBelief 
                 + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                 + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                 + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                 + mat_imd + par_occSocClass + par_income + mat_home,
...
preds_rr
write_csv(preds_rr, file = "dep_efficacy_MI_AllInts_PredValues.csv")
...
dat_mi <- dat_mi %>%
  relocate(epds, climateConcern, totalActions, concernXaction_concerned, concernXaction_veryConcerned, 
           smfq, prior_dep, gad7_prior, prior_anx, wemwbs_prior,
           sex, ethnicity, relationship, children, edu, occClass, income, imd, home,
           emoStab, openness, mat_dep, mat_anx, pat_dep, pat_anx, mat_age, mat_edu,
           mat_imd, par_occSocClass, par_income, mat_home, wemwbs) %>%
...
#set.seed(54345)
#imp_mi <- smcfcs(dat_mi, m = 50, numit = 10, noisy = TRUE, smtype = "lm",
#                 smformula = "epds ~ climateConcern + totalActions + concernXaction_concerned + concernXaction_veryConcerned + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior + sex + ethnicity + relationship + children + edu + occClass + income + imd + home + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu + mat_imd + par_occSocClass + par_income + mat_home + wemwbs",
#               method = c("", "podds", "norm", 
...
#                          "", "logreg", "logreg", "logreg", "podds", "podds", "podds", "podds", "mlogit",
#                          "norm", "norm", "norm", "norm", "norm", "norm", "norm", "podds",
#                          "podds", "podds", "podds", "mlogit", "norm"),
#               rjlimit = 10000)



## Am getting some errors here ("Error in rmultinom(1, size = 1, prob = prob) : NA in probability vector"), and the imputations are failing. Not quite sure the reason for this error, especially as it does not occur on every iteration - Presumably due to multinomial imputation models, so will replace all these (and use 'logreg' instead for 'home', by converting the unordered variables to binary variables)
...
imp_mi <- smcfcs(dat_mi, m = 50, numit = 10, noisy = FALSE, smtype = "lm",
                 ...
                 method = c("", "podds", "norm", 
                            ...
                            "norm", "norm", "norm", "norm", "norm", "norm", "norm", "podds",
                            "podds", "podds", "podds", "logreg", "norm"),
                 rjlimit = 10000)


## Save these imputations, to avoid having to run the imputations again
save(imp_mi, file = "MI_dep_totalActions_SMCFCS.RData")
#load("MI_dep_totalActions_SMCFCS.RData")
...
## Unadjusted
model <- with(smcfcs_imp, lm(epds ~ climateConcern + totalActions + climateConcern:totalActions))
est <- pool(model)
...
preds_rr
write_csv(preds_rr, file = "dep_actions_MI_SMCFCS_PredValues.csv")


### And also check the main effects model
model <- with(smcfcs_imp, lm(epds ~ climateConcern))
est <- pool(model)
(results_smfcs_main <- summary(est, conf.int = TRUE))

model <- with(smcfcs_imp, lm(epds ~ climateConcern + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                         + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                         + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                         + mat_imd + par_occSocClass + par_income + mat_home))
est <- pool(model)
...
for (i in 1:length(imp_mi$impDatasets)) {
  print(paste0("On imputed dataset: ", i))
  df_temp <- smcfcs_imp$imputations[[i]]
  mod_temp_unadj <- lm(epds ~ climateConcern, data = df_temp)
  mod_temp_adj <- lm(epds ~ climateConcern + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                 + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                 + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                 + mat_imd + par_occSocClass + par_income + mat_home,
                 data = df_temp)
...
var_total <- var_within + ((1 + (1 / length(imp_mi$impDatasets))) * var_between)
se_total <- sqrt(var_total)
mean_RR; mean_RR - (1.96 * se_total); mean_RR + (1.96 * se_total); 2*pnorm(q= mean_RR / se_total, lower.tail=FALSE)
...
## Re-order the variables so they appear in the dataset the same order as the SMCFCS formula and methods - Also make some variables ordered factors (as SMCFCS needs this specified)
dat_mi <- dat_mi %>%
  relocate(epds, climateConcern, actionBelief, concernXbelief_concerned, concernXbelief_veryConcerned, 
           smfq, prior_dep, gad7_prior, prior_anx, wemwbs_prior,
           sex, ethnicity, relationship, children, edu, occClass, income, imd, home,
           emoStab, openness, mat_dep, mat_anx, pat_dep, pat_anx, mat_age, mat_edu,
           mat_imd, par_occSocClass, par_income, mat_home, wemwbs) %>%
...
set.seed(34543)
imp_mi <- smcfcs(dat_mi, m = 50, numit = 10, noisy = FALSE, smtype = "lm",
                 smformula = "epds ~ climateConcern + actionBelief + concernXbelief_concerned + concernXbelief_veryConcerned + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior + sex + ethnicity + relationship + children + edu + occClass + income + imd + home + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu + mat_imd + par_occSocClass + par_income + mat_home + wemwbs",
...
## Save these imputations, to avoid having to run the imputations again
save(imp_mi, file = "MI_dep_actionBelief_SMCFCS.RData")
#load("MI_dep_actionBelief_SMCFCS.RData")
...
## Unadjusted
model <- with(smcfcs_imp, lm(epds ~ climateConcern + actionBelief + climateConcern:actionBelief))
est <- pool(model)
...
preds_rr
write_csv(preds_rr, file = "dep_efficacy_MI_SMCFCS_PredValues.csv")
