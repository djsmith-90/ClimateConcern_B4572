...
### Script 4b: Analysis for Research Question 2 - Moderators between climate concern and anxiety
...
dat_actions <- dat %>%
  select(-c(actionBelief, epds, wemwbs))
...
### Unadjusted
actions_cca_unadj <- lm(gad7 ~ climateConcern + totalActions + climateConcern:totalActions, 
                        data = dat_actions, subset = cca == TRUE)
summary(actions_cca_unadj)
round(confint(actions_cca_unadj), 2)

### Adjusted
actions_cca_adj <- lm(gad7 ~ climateConcern + totalActions + climateConcern:totalActions 
...
# Make CCA marker, so unadjusted and adjusted models have the same sample size - NOTE: Only 422 complete cases
dat_belief <- dat %>%
  select(-c(totalActions, epds, wemwbs))
...
### Unadjusted
beliefs_cca_unadj <- lm(gad7 ~ climateConcern + actionBelief + climateConcern:actionBelief, 
                        data = dat_belief, subset = cca == TRUE)
summary(beliefs_cca_unadj)
round(confint(beliefs_cca_unadj), 2)

### Adjusted
beliefs_cca_adj <- lm(gad7 ~ climateConcern + actionBelief + climateConcern:actionBelief 
                      + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                      + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                      + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                      + mat_imd + par_occSocClass + par_income + mat_home, 
...
## Remove other moderator from dataset (as will impute separately below), in addition to depression outcome (as measured at same time-point as anxiety outcome, provides no additional information to inform imputations)
dat_mi <- dat %>%
  select(-c(epds, actionBelief))
...
form <- as.list(c(
  as.formula(smfq ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(prior_dep ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(gad7_prior ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(prior_anx ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(wemwbs_prior ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + prior_anx + gad7_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(sex ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(ethnicity ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(relationship ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(children ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(edu ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(occClass ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(income ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(imd ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(home ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(emoStab ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(openness ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_dep ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_anx ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(pat_dep ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(pat_anx ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_age ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_edu ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_imd ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(par_occSocClass ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_income + mat_home + wemwbs),
  as.formula(par_income ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + mat_home + wemwbs),
  as.formula(mat_home ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + wemwbs),
  as.formula(climateConcern ~ gad7 + totalActions + gad7:totalActions 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(totalActions ~ gad7 + climateConcern + gad7:climateConcern 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(gad7 ~ climateConcern + totalActions + climateConcern:totalActions 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(wemwbs ~ climateConcern + totalActions + climateConcern:totalActions + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home)
...
imp_mi <- mice(dat_mi, m = 50, maxit = 10, 
               method = meth, formulas = form, print = TRUE, seed = 321321)

## Save these imputations, to avoid having to run the imputations again
save(imp_mi, file = "MI_anx_totalActions_allInts.RData")
#load("MI_anx_totalActions_allInts.RData")


#### Now run substantive analysis model in each imputed dataset and combine using Rubin's rules

## Unadjusted
model <- with(imp_mi, lm(gad7 ~ climateConcern + totalActions + climateConcern:totalActions))
est <- pool(model)
...
for (i in 1:imp_mi$m) {
  ...
  mod_temp <- lm(gad7 ~ climateConcern + totalActions + climateConcern:totalActions 
                 + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                 + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                 + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                 + mat_imd + par_occSocClass + par_income + mat_home,
...
preds_rr
write_csv(preds_rr, file = "anx_actions_MI_allInts_PredValues.csv")
...
form <- as.list(c(
  as.formula(smfq ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(prior_dep ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(gad7_prior ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(prior_anx ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(wemwbs_prior ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + prior_anx + gad7_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(sex ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(ethnicity ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(relationship ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(children ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(edu ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(occClass ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(income ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(imd ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(home ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(emoStab ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(openness ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_dep ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_anx ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(pat_dep ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(pat_anx ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_age ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_edu ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(mat_imd ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(par_occSocClass ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_income + mat_home + wemwbs),
  as.formula(par_income ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + mat_home + wemwbs),
  as.formula(mat_home ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + wemwbs),
  as.formula(climateConcern ~ gad7 + actionBelief + gad7:actionBelief 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(actionBelief ~ gad7 + climateConcern + gad7:climateConcern 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(gad7 ~ climateConcern + actionBelief + climateConcern:actionBelief 
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home + wemwbs),
  as.formula(wemwbs ~ climateConcern + actionBelief + climateConcern:actionBelief + gad7
             + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
             + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
             + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
             + mat_imd + par_occSocClass + par_income + mat_home)
...
## Now run the proper imputation model. Will create 50 imputed datasets here with a burn-in period of 10 iterations
imp_mi <- mice(dat_mi, m = 50, maxit = 10, 
               method = meth, formulas = form, print = TRUE, seed = 123123)

## Save these imputations, to avoid having to run the imputations again
save(imp_mi, file = "MI_anx_actionBelief_allInts.RData")
#load("MI_anx_actionBelief_allInts.RData")


#### Now run substantive analysis model in each imputed dataset and combine using Rubin's rules

## Unadjusted
model <- with(imp_mi, lm(gad7 ~ climateConcern + actionBelief + climateConcern:actionBelief))
est <- pool(model)
...
for (i in 1:imp_mi$m) {
  print(paste0("On imputed dataset: ", i))
  df_temp <- complete(imp_mi, i)
  mod_temp <- lm(gad7 ~ climateConcern + actionBelief + climateConcern:actionBelief 
                 + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                 + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                 + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                 + mat_imd + par_occSocClass + par_income + mat_home,
...
preds_rr
write_csv(preds_rr, file = "anx_efficacy_MI_allInts_PredValues.csv")
...
dat_mi <- dat_mi %>%
  relocate(gad7, climateConcern, totalActions, concernXaction_concerned, concernXaction_veryConcerned, 
           smfq, prior_dep, gad7_prior, prior_anx, wemwbs_prior,
           sex, ethnicity, relationship, children, edu, occClass, income, imd, home,
           emoStab, openness, mat_dep, mat_anx, pat_dep, pat_anx, mat_age, mat_edu,
           mat_imd, par_occSocClass, par_income, mat_home, wemwbs) %>%
...
## Save these imputations, to avoid having to run the imputations again
save(imp_mi, file = "MI_anx_totalActions_SMCFCS.RData")
#load("MI_anx_totalActions_SMCFCS.RData")
...
## Unadjusted
model <- with(smcfcs_imp, lm(gad7 ~ climateConcern + totalActions + climateConcern:totalActions))
est <- pool(model)
...
preds_rr
write_csv(preds_rr, file = "anx_actions_MI_SMCFCS_PredValues.csv")


### And also check the main effects model
model <- with(smcfcs_imp, lm(gad7 ~ climateConcern))
est <- pool(model)
(results_smfcs_main <- summary(est, conf.int = TRUE))

model <- with(smcfcs_imp, lm(gad7 ~ climateConcern + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                         + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                         + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                         + mat_imd + par_occSocClass + par_income + mat_home))
est <- pool(model)
...
for (i in 1:length(imp_mi$impDatasets)) {
  print(paste0("On imputed dataset: ", i))
  df_temp <- smcfcs_imp$imputations[[i]]
  mod_temp_unadj <- lm(gad7 ~ climateConcern, data = df_temp)
  mod_temp_adj <- lm(gad7 ~ climateConcern + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior
                     + sex + ethnicity + relationship + children + edu + occClass + income + imd + home 
                     + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu 
                     + mat_imd + par_occSocClass + par_income + mat_home,
                     data = df_temp)
...
## Re-order the variables so they appear in the dataset the same order as the SMCFCS formula and methods - Also make some variables ordered factors (as SMCFCS needs this specified)
dat_mi <- dat_mi %>%
  relocate(gad7, climateConcern, actionBelief, concernXbelief_concerned, concernXbelief_veryConcerned, 
           smfq, prior_dep, gad7_prior, prior_anx, wemwbs_prior,
           sex, ethnicity, relationship, children, edu, occClass, income, imd, home,
           emoStab, openness, mat_dep, mat_anx, pat_dep, pat_anx, mat_age, mat_edu,
           mat_imd, par_occSocClass, par_income, mat_home, wemwbs) %>%
...
set.seed(543543)
imp_mi <- smcfcs(dat_mi, m = 50, numit = 10, noisy = FALSE, smtype = "lm",
                 smformula = "gad7 ~ climateConcern + actionBelief + concernXbelief_concerned + concernXbelief_veryConcerned + smfq + prior_dep + gad7_prior + prior_anx + wemwbs_prior + sex + ethnicity + relationship + children + edu + occClass + income + imd + home + emoStab + openness + mat_dep + mat_anx + pat_dep + pat_anx + mat_age + mat_edu + mat_imd + par_occSocClass + par_income + mat_home + wemwbs",
...
## Save these imputations, to avoid having to run the imputations again
save(imp_mi, file = "MI_anx_actionBelief_SMCFCS.RData")
#load("MI_anx_actionBelief_SMCFCS.RData")
...
## Unadjusted
model <- with(smcfcs_imp, lm(gad7 ~ climateConcern + actionBelief + climateConcern:actionBelief))
est <- pool(model)
...
preds_rr
write_csv(preds_rr, file = "anx_efficacy_MI_SMCFCS_PredValues.csv")
